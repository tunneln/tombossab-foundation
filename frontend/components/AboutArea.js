        ...
        <section className="about-area">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-7" style={{'paddingBottom': '150px'}}>
                        <div className="about-heading">
                            <div className="section-heading">
                                ...
                                The mission of the Tombossa B Foundation is to honor Tombossa’s enduring legacy by uplifting and empowering our Eritrean and East African communities. With unwavering dedication, we will provide financial aid, vital resources, and mental health support to create transformative opportunities for underserved youth. Through our commitment to sustainable initiatives, we foster resilient communities that not only preserve their rich heritage but also open doors to endless possibilities, paving the way for a brighter, more hopeful future.
                                </p>
                            </div>
                        </div>
                    </div>
