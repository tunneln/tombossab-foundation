                            ...
                            <div className="row">
                                <div className="col-lg-4">
                                    <div className="entry-video-img">
                                        <img src="/images/entry-video-img.jpg" alt="" />
                                        {isOpen && <VideoModal videoId="pOK_yA0WG98" onClose={() => setIsOpen(false)} />}
                                            <div onClick={() => setIsOpen(true)} className="mfp-iframe video-play-btn"
