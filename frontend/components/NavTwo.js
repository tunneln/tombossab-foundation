                                ...
                                <div className="top-action-content">
                                    <div className="info-box info-box-1 d-flex align-items-center">
                                        <ul className="d-flex align-items-center">
                                            <li><a href="mailto:contact@tombossabfoundation.org"><i className="fa fa-envelope"></i>contact@tombossabfoundation.org</a>
                                            </li>
                                            <li><a href="#"><i className="fa fa-phone-square"></i>927 392 7701</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-5 col-sm-5 site-branding">
                                <div className="logo-action d-flex align-items-center">
                                    <div className="ostion-logo">
                                        <Link href="/">
                                            <a href="">
                                                <img src="/images/logo2.png" alt="Tombossa B Foundation" title="Tombossa B Foundation" />
                                            </a>
                                        </Link>
                                    </div>
                                </div>
                ...
                <div className="side-nav-container">
                    ...
                    <div className="side-menu-wrap">
                        <ul className="side-menu-ul">
                            ...
                            <li className="sidenav__item"><a href="/events">events</a>
                                <span className="menu-plus-icon"></span>
                            </li>
